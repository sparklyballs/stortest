...
RUN \
	...
	&& git clone --branch ${RELEASE} --recurse-submodules=mozilla-ca https://github.com/Stor-Network/stor-blockchain.git . \
	&& /bin/sh ./install.sh
...
# copy build files
COPY --from=stor_build /stor-blockchain /stor-blockchain
